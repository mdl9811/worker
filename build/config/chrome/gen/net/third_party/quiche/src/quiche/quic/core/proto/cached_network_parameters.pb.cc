...
PROTOBUF_CONSTEXPR CachedNetworkParameters::CachedNetworkParameters(
  ...
  , /*decltype(_impl_.bandwidth_estimate_bytes_per_second_)*/0
  , /*decltype(_impl_.min_rtt_ms_)*/0
  , /*decltype(_impl_.previous_connection_state_)*/0
  , /*decltype(_impl_.max_bandwidth_estimate_bytes_per_second_)*/0
  , /*decltype(_impl_.max_bandwidth_timestamp_seconds_)*/int64_t{0}
...
CachedNetworkParameters::CachedNetworkParameters(const CachedNetworkParameters& from)
  ...
  CachedNetworkParameters* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.serving_region_){}
    , decltype(_impl_.bandwidth_estimate_bytes_per_second_){}
    , decltype(_impl_.min_rtt_ms_){}
    , decltype(_impl_.previous_connection_state_){}
    , decltype(_impl_.max_bandwidth_estimate_bytes_per_second_){}
    , decltype(_impl_.max_bandwidth_timestamp_seconds_){}
  ...
  if (from._internal_has_serving_region()) {
    _this->_impl_.serving_region_.Set(from._internal_serving_region(), 
...
void CachedNetworkParameters::InternalSwap(CachedNetworkParameters* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.serving_region_, lhs_arena,
      &other->_impl_.serving_region_, rhs_arena
  );
